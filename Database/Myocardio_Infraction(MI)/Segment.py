...
# Load the dataset
df = pd.read_csv("MI_Normalized.csv")
...
set_a.to_csv("SetA_MI_Normalized.csv", index=False)
set_b.to_csv("SetB_MI_Normalized.csv", index=False)
set_c.to_csv("SetC_MI_Normalized.csv", index=False)
